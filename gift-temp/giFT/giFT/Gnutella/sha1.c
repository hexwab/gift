/*
 * $Id: sha1.c,v 1.10 2003/05/05 09:04:02 hipnod Exp $
 *
...
/* 
 * New, faster sha1 code. The original code was from Bitzi corporation,
 * and was in the public domain. The original header is included.
 */
