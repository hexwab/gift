/*
 * $Id: parse.h,v 1.15 2003/05/05 11:53:47 jasta Exp $
 *
 ...
 * @param dst
 * @param src
 * @param size  Total size of the destination buffer.  Please note that
 *              the last byte will always be written as NUL, regardless of
 *              how much data was copied from src.
 *
