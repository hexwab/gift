/*
 * $Id: fdbuf.h,v 1.3 2003/03/13 13:03:45 jasta Exp $
 *
 ...
 *
 * This interface is intended to be used through a TCPConn object.  A buffer
 * will be created on ::connection_open or ::connection_accept.
 */
