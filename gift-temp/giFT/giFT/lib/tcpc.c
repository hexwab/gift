/*
 * $Id: tcpc.c,v 1.5 2003/04/19 10:41:30 jasta Exp $
 *
...
#if 0
    if (c->in > 128 || c->out > 128)
		TRACE_SOCK (("in=%lu, out=%lu", c->in, c->out));
#endif
