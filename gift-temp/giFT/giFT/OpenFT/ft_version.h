/*
 * $Id: ft_version.h,v 1.5 2003/05/05 09:49:12 jasta Exp $
 *
 ...
 */
FTVersion ft_version (uint8_t major, uint8_t minor,
                      uint8_t micro, uint8_t rev);

/**
 * Parse the version.
 */
void ft_version_parse (FTVersion version, uint8_t *major, uint8_t *minor,
                       uint8_t *micro, uint8_t *rev);
