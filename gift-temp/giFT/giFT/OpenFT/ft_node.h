/*
 * $Id: ft_node.h,v 1.13 2003/05/05 09:49:09 jasta Exp $
 *
...
{
	uint32_t       version;            /**< OpenFT ver, see ft_version.c */
	...
	in_port_t      port;               /**< OpenFT port, 0 if firewalled */
	in_port_t      http_port;          /**< HTTP port */
