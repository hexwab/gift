/*
 * $Id: ft_netorg.c,v 1.16 2003/05/05 09:49:09 jasta Exp $
 *
                       ...
                       FTNetorgForeach func, void *udata)
{
	...
	else
	{
		...
		iter_state (klass, NODE_CONNECTED, iter, &looped, func, udata);
		iter_state (klass, NODE_CONNECTING, iter, &looped, func, udata);
		iter_state (klass, NODE_DISCONNECTED, iter, &looped, func, udata);
	}
