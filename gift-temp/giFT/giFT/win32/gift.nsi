# $Id: gift.nsi,v 1.38 2003/05/04 20:53:52 rossta Exp $
# See README.nsis for details on use.

#!ifndef GIFT_DATE
#!define GIFT_DATE "Tue Mar 18 06:48:37 2003 UTC"
#!endif
...
# if you've built the source via nmake /f makefile.msvc static=1, include the following:
	File ..\src\giFT.exe

# if you've built the source via nmake /f makefile.msvc ..., include the following:
#	File ..\src\gift.dll
#	File ..\lib\libgift.dll
#	File ..\OpenFT\OpenFT.dll
#	File ..\Gnutella\Gnutella.dll
...
Section "KCeasy 0.6 (C++ Builder front end)"
	SectionIn 1
