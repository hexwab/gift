/*
 * $Id: gt_xfer.c,v 1.100 2004/06/04 15:44:58 hipnod Exp $
 *
...
static BOOL is_firewalled_source (GtSource *gt)
{
...
static BOOL should_push (GtSource *gt)
{
	...
	/* we should send a push if they set the firewalled bit */
	if (is_firewalled_source (gt))
		return TRUE;
