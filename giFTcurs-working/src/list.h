 ...
 *
 * $Id: list.h,v 1.37 2002/11/08 17:54:06 chnix Exp $
 */
#ifndef _LIST_H
#define _LIST_H
...
void list_resort(list * snafu, int pos);
void list_insort(list * snafu, void *item);

typedef void (*LFunc) (void *data);
void list_foreach(list * snafu, LFunc func);

typedef int (*LFilter) (void *data, void *udata);
void list_filter(list * snafu, LFilter func, void *udata, void (*destroy) (void *));
