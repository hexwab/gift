/*
 * $Id: meta_ogg.c,v 1.12 2003/05/26 11:47:41 jasta Exp $
 *
...
int meta_ogg_run (FileShare *file, char *path)
{
	...
	if (bitrate > 0)
		share_set_meta (file, "bitrate", stringf ("%li", (long)bitrate));

	share_set_meta (file, "frequency", stringf ("%li", freq));
	share_set_meta (file, "duration",  stringf ("%i", dur));
