/*
 * $Id: conf.h,v 1.14 2003/06/04 17:22:48 jasta Exp $
 *
 ...
 *
 * @param comments_allowed  If FALSE, comments will not be parsed out of
 *                          configuration file.  Literal '#' characters will
 *                          be saved.
 */
