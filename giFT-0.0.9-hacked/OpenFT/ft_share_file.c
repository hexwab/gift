/*
 * $Id: ft_share_file.c,v 1.18 2003/05/30 06:42:10 jasta Exp $
 *
...
Share *ft_share_new (FTSHost *shost, off_t size,
                     unsigned char *md5, char *mime, char *filename)
{
	...
	share_set_udata (file, "OpenFT", ft_share_new_data (file, shost));
