/*
 * $Id: ft_search_db.h,v 1.29 2005/01/25 04:43:03 hexwab Exp $
 *
...
typedef struct ft_search_db
{
	...
	int           id;                  /* index in the child list */
} FTSearchDB;
 ...
 */
int ft_search_db_tokens (Array **a, char *realm, struct tokenized *query,
			 struct tokenized *exclude, int max_results);
