/*
 * $Id: ft_share_file.h,v 1.11 2003/06/24 19:57:20 jasta Exp $
 *
...
typedef struct
{
	struct ft_node *node;              /**< reference the share host parent
 ...
 */
FTShare *ft_share_new_data (Share *file, struct ft_node *node);
