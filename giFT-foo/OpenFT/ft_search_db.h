/*
 * $Id: ft_search_db.h,v 1.13 2003/06/24 19:57:20 jasta Exp $
 *
...
#ifdef USE_LIBDB
	DB     *db;                        /**< open database handle */
	char   *dbname;                    /**< database name, usually
	                                    *   concat of ip and creation time */

	DB_TXN *remove_txn;                /**< optional transaction to wrap
	                                    *   all remove host operations */
