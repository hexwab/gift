/*
 * $Id: example.c,v 1.14 2003/05/29 08:13:35 jasta Exp $
 *
 * Build with:
 *
 *   gcc -o example example.c -g -Wall `pkg-config --cflags --libs libgift`
 *
...
int main (int argc, char **argv)
{
	...
	/**
	 * Initialize libgift before usage...
	 */
	libgift_init ("example", GLOG_STDOUT, NULL);
