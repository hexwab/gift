/*
 * $Id: enc_type_2.c,v 1.14 2004/07/23 19:26:53 hex Exp $
 *
 * Copyright (C) 2003 giFT-FastTrack project
developer.berlios.de/projects/gift-fasttrack
 *
...
u32 mini2 (unsigned int *key, unsigned int seed)
{
	mix_major0 (key, seed);
	return key[7];
}
...
unsigned int mangle2 (unsigned int seed)
{
