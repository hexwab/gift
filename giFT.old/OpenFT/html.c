...
/* #define IMAGE_HOST "http://www.theproject.nu/~stoned/gift" */
...
char *html_page_index (char *file)
{
	...
	fprintf (f, "<H1><A HREF=\"http://www.giftproject.org/\">%s %s</A> (%s)</H1>\n", PACKAGE, VERSION, GIFT_CVSID);
	fprintf (f, "<H1>Node Status: %s</H1>\n", node_class_str (NULL));

	fprintf (f,
	         "<H2>Node List</H2>\n"
	         "<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=2>\n"
	         "<TR><TD><B>Node</B></TD><TD><B>Classification</B></TD><TD><B><BR></B></TD></TR>\n");
