...
#ifdef DEBUG
# define TRACE_SOCK(args)   (fprintf (stderr, "%-12s:%-4i %s (%s): ", __FILE__, __LINE__, __PRETTY_FUNCTION__, net_peer_ip (c ? c->fd : -1)), printf args, printf ("\n"))
#else /* !DEBUG */
