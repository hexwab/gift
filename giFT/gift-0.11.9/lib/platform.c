/*
 * $Id: platform.c,v 1.84 2005/11/24 22:24:55 mkern Exp $
 *
...
# include <sys/timeb.h>
# define WS_MAJOR 2
# define WS_MINOR 1   /* There are winsocks which do not support 2.0 */
# ifndef R_OK
#   define R_OK 04
# endif
...
# endif /* HAVE_NICE */
	...
	if (!SetThreadPriority (hThread, THREAD_PRIORITY_LOWEST))
		GIFT_WARN (("Couldn't lower priority of hashing thread."));
