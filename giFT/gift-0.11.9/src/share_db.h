/*
 * $Id: share_db.h,v 1.9 2006/01/30 16:38:42 mkern Exp $
 *
...
/**
 * Returns TRUE if a corruped record was read from the database and we cannot
 * safely read further records.
 *
 * @return Boolean TRUE if there was a read error.
 */
