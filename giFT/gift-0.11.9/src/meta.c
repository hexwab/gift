/*
 * $Id: meta.c,v 1.31 2006/09/12 14:50:32 mkern Exp $
 *
...
#include "meta/meta_mpeg.h"
#include "meta/meta_torrent.h"
#include "meta/meta_import.h"
...
static BOOL run_handler (Share *share, const char *host_path)
{
	...
	for (handler = meta_handlers; handler->mime != NULL; handler++)
	{
		...
		/* matched, call the handler and abort */
		if (cmp == 0)
		{
