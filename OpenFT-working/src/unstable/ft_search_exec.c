/*
 * $Id: ft_search_exec.c,v 1.58 2004/01/07 12:06:42 jasta Exp $
 *
	 ...
	 case FT_SEARCH_FILENAME:
		{
			...
			{
#if 0
			  /* now that ft_tokenize_* can return NULL if
			   * there are no tokens, empty searches will
			   * aborted without being propagated */
#endif
