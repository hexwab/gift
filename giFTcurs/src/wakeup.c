 ...
 * Copyright (C) 2002, 2003 Christian Häggström <chm@c00.info>
 *
 ...
 *
 * $Id: wakeup.c,v 1.21 2003/06/27 11:20:15 weinholt Exp $
 */
...
int init(int argc, char *argv[])
{
  ...
  ok:
	...
	gift_stream = g_io_channel_unix_new(gift_fd);
