...
{
	/* NOTE: this function will eventually attempt a connection to this user
	 * and deliver the packet once the connection can be established */
	return ft_packet_send (conn_lookup (to), packet);
}
