...
typedef struct
{
	 ...
	 */
	Connection   *c;                   /**< Actual socket connection to the
	                                    *   remote node */
	...
	Connection     *verify_openft;     /**< Connection made in an attempt
	                                    *   to verify the port supplied by
	                                    *   this node on handshaking */
	Connection     *verify_http;       /**< Same as verify_openft, except that
