...
/* define to use ZLIB compression library */
/* #define USE_ZLIB */

/* define to use MP3 ID3 library library */
/* #define USE_ID3LIB */

/* #define ID3LIB_LINKOPTION 1 */

/* define to use image magick library */
/* #define USE_IMAGEMAGICK */

/* define to use Berkeley DB library */
/* #define USE_LIBDB */
...
/* define to use Ogg Vorbis library */
/* #define USE_LIBVORBIS */

/* define to use Perl hooks */
/* #undef USE_PERL */
...
/* Define to 'ft_uint32' if <netinet/in.h> does not define. */
/* Actually, let's use winsock's u_long so we don't rely on giftconfig.h */
