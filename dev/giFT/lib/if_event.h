...
struct _if_event;
typedef void (*IFEventCB) (Connection *c, struct _if_event *event, void *udata);
...
IFEvent  *if_event_new    (Connection *c, IFEventID session_id,
                           IFEventFlags flags,
