...
#ifdef _DEBUG_NOT
# define DEBUG_TAG (0x12345678UL)
# define VALIDATE(obj) OBJECT_DATA (obj)->debug_tag = DEBUG_TAG
# define ASSERT_VALID(obj) assert (OBJECT_DATA (obj)->debug_tag == DEBUG_TAG)
#else
# define VALIDATE(obj)
